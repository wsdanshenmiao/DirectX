...
//#endif
    ...
    m_pd3dImmediateContext->Dispatch(8, 8, 1);
...
//#endif
    ...
    SaveDDSTextureToFile(m_pd3dImmediateContext.Get(), m_pTextureOutput.Get(), L"..\\Texture\\Color.dds");
...
bool GameApp::InitResource()
{
    ...
    CreateDDSTextureFromFile(m_pd3dDevice.Get(), L"..\\Texture\\Red.dds",
        nullptr, m_pTextureInputA.GetAddressOf());
    CreateDDSTextureFromFile(m_pd3dDevice.Get(), L"..\\Texture\\Yellow.dds",
